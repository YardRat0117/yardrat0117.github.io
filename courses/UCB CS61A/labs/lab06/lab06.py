    ...
    def report(self):
        ...
        if self.changed():
            if self.before < self.after:
                ...
                variation = 'decreased '
            result = str(self.id) + ': ' + variation + str(self.before) + '->' + str(self.after) 
        else:
            result = str(self.id) + ': ' + msg
        return result
...
class Account:
    ...
    def deposit(self, amount):
        ...
        after = self.balance
        currTrans = Transaction(self.transId, before, after)
        self.transactions.append(currTrans)
        self.transId += 1
...
class ChangeMachine:
    ...
    def change(self, coin):
        ...
        for changeCoin in changes:
            if changeCoin in self.coins:
                self.coins[changeCoin] -= 1
                if self.coins[changeCoin] == 0:
                    del self.coins[changeCoin]
